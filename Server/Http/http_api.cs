...
namespace Http {
    ...
    public sealed partial class HttpServer : IDisposable {
        ...
        //
        // Enable if you want responses to gzip. This only is used if the
        // client supports gzip encoding. You can override this per response
        // using the GZipContent property of HttpResponse.
        //
        public bool GZipContent { set; get; }

        //
        // Get or set the temp directory used for large file uploads
        //
    ...
    public sealed partial class HttpTransaction {
        ...
        //
        // This event is fires when the transaction completes cleanly. 
        //
        public event HttpTransactionCompletedDelegate Completed; 
    ...
    public sealed partial class HttpResponse {
        ...
        public void Respond(HttpStatusCode status, Stream body, long tocopy) { _Respond(status, body, tocopy); }
        ...
        public void Respond(Stream body, int tocopy)            { _Respond(HttpStatusCode.OK, body); }
        ...
        // Enable if you want this response to gzip. This only is used if the
        // client supports gzip encoding, and picks up its default value from
        // the HttpServer
        public bool GZipContent { set; get; }
        ...
        //
        // If GzipPermitted is true, consider gzipping the response data before feeding into buffer.
        //                                                                                   u
        ...
        //
        // True if request was accompanied with an Accept-Encoding header containing "gzip". If true, server may (but is
        // not required to) gzip the response.
        //
        public bool GzipPermitted { get { return _gzip_permitted; } }
    }
    ...
    public sealed class HttpTransactionStats {
        public long BytesReceived { get; set; }
        public long BytesSent     { get; set; }
    }

    public delegate void HttpTransactionCanceledDelegate(HttpTransaction tx);
    public delegate void HttpTransactionCompletedDelegate(HttpTransaction tx, HttpTransactionStats stats);
    ...
    public sealed partial class UploadedFile : IDisposable {
        ...
        public void Dispose() { 
            if (Contents     != null) { Contents.Close (); Contents = null; } 
